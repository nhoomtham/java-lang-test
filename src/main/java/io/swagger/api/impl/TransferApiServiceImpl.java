...
public class TransferApiServiceImpl extends TransferApiService {
      ...
      @Override
      public Response createTransfer(String xref,String recipient,Integer amount,SecurityContext securityContext)
      ...
      @Override
      public Response findTransferById(String id,SecurityContext securityContext)
      throws NotFoundException {
      // do some magic!
      return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
  }
